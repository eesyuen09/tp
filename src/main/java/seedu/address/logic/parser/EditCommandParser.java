...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        parseTagsForEdit(argMultimap.getAllValues(PREFIX_CLASSTAG)).ifPresent(editPersonDescriptor::setTags);
     ...
     */
    private Optional<Set<ClassTag>> parseTagsForEdit(Collection<String> tags) throws ParseException {
        assert tags != null;
        ...
        return Optional.of(ParserUtil.parseClassTags(tagSet));
    }

    /**
     * Checks if the student ID prefix is present in the given {@code ArgumentMultimap}.
    */
    private static boolean arePrefixesPresent(ArgumentMultimap argumentMultimap) {
        return argumentMultimap.getValue(CliSyntax.PREFIX_STUDENTID).isPresent();
    }
