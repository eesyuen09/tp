...
public class JsonAdaptedAttendanceTest {
    ...
    public void toModelType_validAttendanceDetails_returnsAttendance() throws Exception {
        Attendance attendance = new Attendance(new Date(VALID_DATE), VALID_IS_PRESENT);
    ...
    public void toModelType_invalidDate_throwsIllegalValueException() {
        JsonAdaptedAttendance jsonAttendance =
                new JsonAdaptedAttendance(INVALID_DATE, VALID_IS_PRESENT);
    ...
    public void toModelType_nullDate_throwsIllegalValueException() {
        JsonAdaptedAttendance jsonAttendance = new JsonAdaptedAttendance(null, VALID_IS_PRESENT);
