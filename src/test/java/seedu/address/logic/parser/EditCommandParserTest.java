...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_CLASS_TAG_DESC, ClassTag.MESSAGE_CONSTRAINTS); // invalid tag
        ...
        assertParseFailure(parser, "1" + CLASS_TAG_DESC_MATHS + CLASS_TAG_DESC_PHYSICS + TAG_EMPTY,
                ClassTag.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, "1" + CLASS_TAG_DESC_MATHS + TAG_EMPTY + CLASS_TAG_DESC_PHYSICS,
                ClassTag.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, "1" + TAG_EMPTY + CLASS_TAG_DESC_MATHS + CLASS_TAG_DESC_PHYSICS,
                ClassTag.MESSAGE_CONSTRAINTS);
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + CLASS_TAG_DESC_PHYSICS
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // tags
        userInput = targetIndex.getOneBased() + CLASS_TAG_DESC_MATHS;
