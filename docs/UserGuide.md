...
| Command                                 | Description                                                            |
|-----------------------------------------|------------------------------------------------------------------------|
| `att -p s/STUDENT_ID d/DATE t/TAG_NAME` | Mark a student as present for a given date and class tag               |
| `att -a s/STUDENT_ID d/DATE t/TAG_NAME` | Mark a student as absent for a given date and class tag                |
...
**Format:** `att -p s/STUDENT_ID d/DATE t/TAG_NAME`
...
**Format:** `att -a s/STUDENT_ID d/DATE t/TAG_NAME`
...
| **Mark as PRESENT**         | `att -p s/STUDENT_ID d/DDMMYYYY t/TAG_NAME` <br> e.g., `att -p s/0001 d/15092025 t/Math`                                                                                                 |
| **Mark as ABSENT**          | `att -a s/STUDENT_ID d/DDMMYYYY t/TAG_NAME` <br> e.g., `att -a s/0001 d/15092025 t/Math`                                                                                                 |
